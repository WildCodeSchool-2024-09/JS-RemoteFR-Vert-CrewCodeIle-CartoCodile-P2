export default function PseudoForm() {
	return (
		<article className="bg-secondary rounded-md flex flex-col items-center gap-6 w-64">
			<h2 className="text-primary font-Koulen text-xl">PRET A JOUER ?</h2>
			<p className="text-primary font-NotoSans">
				Entre ton pseudo et c'est parti !
			</p>
			<form className="flex flex-col items-center" action="">
				<label htmlFor="pseudo" className="text-primary font-Koulen text-l">
					Quel est ton pseudo ?
				</label>
				<input
					name="pseudo"
